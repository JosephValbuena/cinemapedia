...
class $FavoriteMoviesTable extends FavoriteMovies
  ...
  static const VerificationMeta _orginalTitleMeta =
      const VerificationMeta('orginalTitle');
  @override
  late final GeneratedColumn<String> orginalTitle = GeneratedColumn<String>(
      'orginal_title', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  List<GeneratedColumn> get $columns =>
      [id, movieId, backdropPath, orginalTitle, posterPath, title, voteAverage];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<FavoriteMovy> instance,
    ...
    if (data.containsKey('orginal_title')) {
      context.handle(
          _orginalTitleMeta,
          orginalTitle.isAcceptableOrUnknown(
              data['orginal_title']!, _orginalTitleMeta));
    } else if (isInserting) {
      context.missing(_orginalTitleMeta);
    }
  ...
  FavoriteMovy map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FavoriteMovy(
      ...
      orginalTitle: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}orginal_title'])!,
...
class FavoriteMovy extends DataClass implements Insertable<FavoriteMovy> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['orginal_title'] = Variable<String>(orginalTitle);
  ...
  FavoriteMoviesCompanion toCompanion(bool nullToAbsent) {
    return FavoriteMoviesCompanion(
      ...
      orginalTitle: Value(orginalTitle),
  ...
  factory FavoriteMovy.fromJson(Map<String, dynamic> json,
    ...
    return FavoriteMovy(
      ...
      orginalTitle: serializer.fromJson<String>(json['orginalTitle']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'orginalTitle': serializer.toJson<String>(orginalTitle),
  ...
  FavoriteMovy copyWith(
      ...
      FavoriteMovy(
        ...
        orginalTitle: orginalTitle ?? this.orginalTitle,
  ...
  FavoriteMovy copyWithCompanion(FavoriteMoviesCompanion data) {
    return FavoriteMovy(
      ...
      backdropPath: data.backdropPath.present
          ...
          : this.backdropPath,
      orginalTitle: data.orginalTitle.present
          ? data.orginalTitle.value
          : this.orginalTitle,
      posterPath:
  ...
  String toString() {
    return (StringBuffer('FavoriteMovy(')
          ...
          ..write('orginalTitle: $orginalTitle, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is FavoriteMovy &&
          ...
          other.orginalTitle == this.orginalTitle &&
...
class FavoriteMoviesCompanion extends UpdateCompanion<FavoriteMovy> {
  ...
  final Value<String> orginalTitle;
  ...
  const FavoriteMoviesCompanion({
    ...
    this.orginalTitle = const Value.absent(),
  ...
  static Insertable<FavoriteMovy> custom({
    ...
    Expression<String>? orginalTitle,
    ...
    return RawValuesInsertable({
      ...
      if (orginalTitle != null) 'orginal_title': orginalTitle,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (orginalTitle.present) {
      map['orginal_title'] = Variable<String>(orginalTitle.value);
    }
...
class $$FavoriteMoviesTableFilterComposer
  ...
  ColumnFilters<String> get orginalTitle => $composableBuilder(
      column: $table.orginalTitle, builder: (column) => ColumnFilters(column));
...
class $$FavoriteMoviesTableOrderingComposer
  ...
  ColumnOrderings<String> get orginalTitle => $composableBuilder(
      column: $table.orginalTitle,
      builder: (column) => ColumnOrderings(column));
...
class $$FavoriteMoviesTableAnnotationComposer
  ...
  GeneratedColumn<String> get orginalTitle => $composableBuilder(
      column: $table.orginalTitle, builder: (column) => column);
  ...
  $$FavoriteMoviesTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String> orginalTitle = const Value.absent(),
